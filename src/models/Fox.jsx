...
const Fox = ({currentAnimation, ...props}) => {
  ...
  const { actions } = useAnimations(animations, group); //attaching actions to the body of animations
  
  useEffect(() => {
    Object.values(actions).forEach((action) => action.stop); //stopping all default actions of the model Object
